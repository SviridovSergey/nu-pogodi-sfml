	...
	window(sf::VideoMode(1200, 693), "Nu pogody")
{
	...
	bgImage.loadFromFile("./imgg/bg.png");
	bgShape.setTexture(&bgImage);
	screenShape.setSize(sf::Vector2f(637, 410));
	screenImage.loadFromFile("./imgg/lu.png");
...
void Game::update()
{
	...
	case 0:
		...
		break;
	case 1:
		screenImage.loadFromFile("./imgg/ld.png");
		screenShape.setTexture(&screenImage);
		break;
	case 2:
		screenImage.loadFromFile("./imgg/ru.png");
		screenShape.setTexture(&screenImage);
		break;
	case 3:
		screenImage.loadFromFile("./imgg/rd.png");
		screenShape.setTexture(&screenImage);
		break;
	}
}